    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="stat-card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control" required placeholder="Enter product name">
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Product Code</label>
                            <input type="text" name="code" class="form-control" required placeholder="e.g. SP-101">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Slug</label>
                            <input type="text" name="slug" id="slug" class="form-control" required readonly placeholder="url-friendly-name">
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="stat-card mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="have_variants" id="haveVariants" value="1">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-lg p-3">Publish Product</button>
                </div>
            </div>
        </div>
    </form>
...
<template id="variantTemplate">
    <div class="variant-item bg-light p-3 rounded-4 mb-3 position-relative">
        ...
        <div class="row g-3">
            <div class="col-md-5">
                <label class="small fw-bold text-muted mb-1">Variant Name (e.g. Size M, Red)</label>
