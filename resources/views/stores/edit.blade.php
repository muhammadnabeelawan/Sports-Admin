    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold mb-0">Edit Store</h2>
            </div>
            ...
            <div class="stat-card">
                <form action="{{ route('stores.update', $store) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $store->title }}" required>
                    </div>
                    ...
                    <div class="d-grid mt-5">
                        <button type="submit" class="btn btn-primary btn-lg">Update Store</button>
                    </div>
                </form>
            </div>
        </div>
